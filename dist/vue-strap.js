...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [_vm._t("before"), _vm._v(" "), ((_vm.type == 'textarea' ? null : _vm.type) === 'checkbox' && (_vm.type !== 'textarea')) ? _c('input', {
	    directives: [{
	      name: "model",
	      rawName: "v-model",
	      value: (_vm.val),
