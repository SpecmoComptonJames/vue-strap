<template>
    <doc-section id="spinner" name="Spinner">
        <div class="bs-example">
            <p>
                <checkbox :checked="fixed" @checked="fixed = arguments[0]" type="info">fixed</checkbox>
            </p>
            <p>
                <v-select :options="['sm','md','lg','xl']" v-model="size"></v-select>
            </p>
            <p>
            ...
            <div>
                <label>Spinner Bound Text:</label>
        ...
        <doc-code language="markup">
            &lt;spinner ref="spinner" global v-model="spinner" size="lg" fixed :text="text">&lt;/spinner>
        </doc-code>
        ...
        <doc-table>
            ...
            <div>
                ...
                <p><code>Boolean</code></p>
                <p><code>false</code></p>
                <p>When is true, set global events for that spinner. Will be ignored if was set another global
                    spinner.</p>
            </div>
            <div>
                <p>size</p>
