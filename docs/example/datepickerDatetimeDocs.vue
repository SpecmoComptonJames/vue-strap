<template>
    <doc-section id="DatepickerDateTime" name="Datepicker DateTime Type">
        <h1>Incomplete - not working. Coming soon</h1>
...
<script>
    ...
    import Datepicker from 'src/DatepickerDatetime.vue'
